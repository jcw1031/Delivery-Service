...
public class StoreUserConverter {
    ...
    public StoreUserResponse toResponse(StoreUserEntity storeUserEntity, StoreEntity storeEntity) {
        StoreUserResponse.UserResponse userResponse = StoreUserResponse.UserResponse.builder()
        ...
        StoreUserResponse.StoreResponse storeResponse = StoreUserResponse.StoreResponse.builder()
